...
//--------------------------------------------------------------------+
#define CONFIG_TOTAL_LEN    (TUD_CONFIG_DESC_LEN + TUD_HID_DESC_LEN * CFG_TUD_HID+TUD_CDC_DESC_LEN*CFG_TUD_CDC+TUD_MSC_DESC_LEN*CFG_TUD_MSC)
...
uint8_t const desc_fs_configuration[] = {
        ...
        TUD_MSC_DESCRIPTOR(ITF_NUM_MSC, 5, EPNUM_MSC, (0x80 | EPNUM_MSC), 64),
        TUD_CDC_DESCRIPTOR(ITF_NUM_CDC, 6, (0x80 | EPNUM_CDC_NOTIF), 8, EPNUM_CDC_DATA, (0x80 | EPNUM_CDC_DATA), 64),
...
char const *string_desc_arr[] = {
        ...
        "ESP",                          // 1: Manufacturer
        "CMSIS-DAP",                    // 2: Product
        "c906w4",                       // 3: Serials, should use chip ID
        "CMSIS-DAP-WIFI",                    // 4: HID Interface
        "MSC",
        "CDC",
};
